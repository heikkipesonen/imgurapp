...
angular.module('imgurapp')
	 ...
	 */
	.directive('slideList', function(Utils){
		return {
			restrict:'A',
			link:function($scope, $element){
				...
				function setPosition(duration){
					...
					if (currentElement){
						currentElement.style.transform = 'translate('+offset.x+'px,'+offset.y+'px)';
						currentElement.style['-webkit-transform'] = 'translate('+offset.x+'px,'+offset.y+'px)';
